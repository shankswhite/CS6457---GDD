...
public class CharacterRootMotionControl : MonoBehaviour
{
    ...
    private void Update()
    {
        if (cinput.enabled)
        {
            ...
            LocomotionThreshold = cinput.LocomotionThreshold;
            isJump = cinput.Jump;
            isCrouch = cinput.Crouch;
            ...
            speed = _inputForward * _inputForward + _inputTurn * _inputTurn;
            if (_inputForward < 0)
            {
                turnAround = true;
            }
    ...
    void FixedUpdate()
    {
        ...
        //{
        //    float targetAngle = Mathf.Atan2(_inputDirection.x, _inputDirection.y) * Mathf.Rad2Deg;
        //    _inputTurn = _inputTurn + targetAngle;
        //}
        ...
        //cinput.StickToWorldspace(this.transform, thirdPersonCam.transform, ref direction, ref charSpeed, ref charAngle, cinput.IsInPivot());
        ...
        //    }
        //}
        //if (speed < LocomotionThreshold && Mathf.Abs(_inputForward) < 0.05f)    // Dead zone
        //{
        ...
        anim.SetFloat("Direction", _inputTurn);
        anim.SetFloat("BackSpeed", backSpeed);
